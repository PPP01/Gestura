...
| Was | Wo | Status |
|---|---|---|
| Upload-Paket (ZIP) | `web-ext-artifacts/gestura-2.6-chrome.zip` | ✅ dasselbe wie Chrome (~1 MB) |
...
Fertig: `web-ext-artifacts/gestura-2.6-chrome.zip`. Neu bauen (falls du auf `main`
...
Edge-Dashboard → **„New extension"** → `gestura-2.6-chrome.zip` hochladen. Edge
...
- [ ] ZIP hochgeladen (`gestura-2.6-chrome.zip`)
