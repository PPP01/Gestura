# Gestura – Store listing copy (EN / DE)

Ready-to-paste text for the Chrome Web Store, Edge Add-ons, and Firefox AMO listings.
...
- Primary languages: English, German (extension itself ships ~40 locales)
