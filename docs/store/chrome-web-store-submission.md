...
| Was | Wo | Status |
|---|---|---|
| Upload-Paket (ZIP) | `web-ext-artifacts/gestura-2.7.0-chrome.zip` | ✅ fertig (1,2 MB, nur Runtime) |
...
Das fertige Paket liegt unter `web-ext-artifacts/gestura-2.7.0-chrome.zip`.
...
Dashboard → **„Add new item"** → `web-ext-artifacts/gestura-2.7.0-chrome.zip`
