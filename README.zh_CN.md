...
支持手势导航、超级拖拽、区域框选、滚轮手势、特殊手势，并可自定义所有手势及更多功能。
</div>
...
- <img src="./assets/icons/square-dashed-mouse-pointer.svg" width="16" height="16"> **区域框选** - 按 Shift + 鼠标拖拽框选页面中的链接，批量打开或复制。
...
- <img src="./assets/icons/globe.svg" width="16" height="16"> **上下文感知搜索菜单** - 向鼠标菜单添加内置搜索引擎条目（带图标）及自定义链接；为菜单配置网站模式，使手势自动匹配当前网站打开对应菜单；支持使用"将当前网站添加到菜单"手势一键完成网站绑定。
